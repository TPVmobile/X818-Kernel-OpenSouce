...
#define VFSSPI_DRDY_PIN     24//74
#define VFSSPI_SLEEP_PIN    23//76
#define VFSSPI_CS_PIN       65//87
#define DO_CHIP_SELECT      0
#define DRDY_ACTIVE_STATUS  1
#define BITS_PER_WORD       8
#define DRDY_IRQ_FLAG       EINTF_TRIGGER_RISING   //EINTF_TRIGGER_RISING   //IRQF_TRIGGER_RISING
#define DEFAULT_BUFFER_SIZE (4096 * 6)
#define DRDY_IRQ_ENABLE			1
#define DRDY_IRQ_DISABLE		0
#define VFSSPI_INT_IRQNO      59

#define FP_3V3_EN 		 56//87

#define DEBUG 0
//#define VFSSPI_TEST

#if  DEBUG
#define DPRINTK(fmt, args...) printk(KERN_EMERG "vfsspi:"fmt, ## args)
//#define DPRINTK(fmt, args...) printk(KERN_EMERG "%s: " fmt, __FUNCTION__, ## args)
#else
...
#define VFS_RESET_HW	'l'
#define VFS_IOCTL_DEVICE_GETINT			_IOR(VFS_RESET_HW, 1, int)
#define VFS_IOCTL_DEVICE_ALIVE			_IOR(VFS_RESET_HW, 2, char[14])
