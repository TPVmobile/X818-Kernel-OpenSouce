...
#define GESTURE_DRIVER_NAME "synaptics_dsx/gesture_driver"
...
static struct device_attribute attrs[] = {
	__ATTR(engine_enable, S_IRUGO,
			synaptics_rmi4_show_error,
			udg_sysfs_engine_enable_store),
	__ATTR(detection_enable, S_IRUGO,
			synaptics_rmi4_show_error,
	...
	__ATTR(detection_index, S_IRUGO,
			...
			synaptics_rmi4_store_error),
	__ATTR(registration_enable, S_IRUGO,
			synaptics_rmi4_show_error,
			udg_sysfs_registration_enable_store),
	__ATTR(registration_begin, S_IRUGO,
			synaptics_rmi4_show_error,
...
static int synaptics_rmi4_udg_init(struct synaptics_rmi4_data *rmi4_data)
{
	...
	udg->udg_dev->dev.parent = &rmi4_data->i2c_client->dev;
