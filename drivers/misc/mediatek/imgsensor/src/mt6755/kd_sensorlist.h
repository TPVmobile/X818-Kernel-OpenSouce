...
UINT32 S5K3P3SX2ND_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(S5K3P3SX2ND_MIPI_RAW)
    {S5K3P3SX2ND_SENSOR_ID, SENSOR_DRVNAME_S5K3P3SX2ND_MIPI_RAW, S5K3P3SX2ND_MIPI_RAW_SensorInit},
#endif
// sf.haizhou add
