...
#endif
// sf.xudog add at 2015.11.20 begin
#if defined(R69006_FHD_DSI_CMD)
	&r69006_fhd_dsi_cmd_lcm_drv,
#endif
#if defined(R69006_FHD_DSI_CMD_XINLI)
	&r69006_fhd_dsi_cmd_lcm_drv_xinli,
#endif
// sf.xudog add at 2015.11.20 end
//add by wq
#if defined(TD4322_FHD_DSI_CMD)
	&td4322_fhd_dsi_cmd_lcm_drv,
#endif
//end 
